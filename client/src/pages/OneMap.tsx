...
function OneMapPage() {
  ...
  const data = useGetOneLocation(Number(id))
  ...
  return (
    <>
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className='lg:pr-[130px]'>
        ...
        <h1 className='font-serif text-[24px] md:text-[30px] lg:text-[36px] text-trans-red uppercase text-center my-2 lg:my-5'>{data?.data?.data?.name}</h1>
